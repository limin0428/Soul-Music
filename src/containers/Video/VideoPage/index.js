        ...
        <div className="video_page">
            <div>
                <div className="video_title">
                    <img src="http://p4.music.126.net/RRy487LJgRteVZnUPL-Ggg==/109951163087436693.jpg?param=200y200" className="video_up_img" alt=""/>
            ...
            <div className="video_t_video">
                <div className="video_item">
                    <div className="video_min">
                        <img src="http://p4.music.126.net/RRy487LJgRteVZnUPL-Ggg==/109951163087436693.jpg" alt=""/>
